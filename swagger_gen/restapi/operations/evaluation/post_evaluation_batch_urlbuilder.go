...
func (o *PostEvaluationBatchURL) WithBasePath(bp string) *PostEvaluationBatchURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *PostEvaluationBatchURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostEvaluationBatchURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostEvaluationBatchURL")
	}
