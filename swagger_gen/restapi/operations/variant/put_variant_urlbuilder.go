...
func (o *PutVariantURL) Build() (*url.URL, error) {
	...
	if flagID != "" {
		...
		return nil, errors.New("FlagID is required on PutVariantURL")
	}
	...
	if variantID != "" {
		...
		return nil, errors.New("VariantID is required on PutVariantURL")
	}
...
func (o *PutVariantURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutVariantURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutVariantURL")
	}
